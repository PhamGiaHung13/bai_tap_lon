...
import minigames.blockblast.BlockBlastPanel;
...
public class GameController {
    ...
    public void onMinigameWin() {
        ...
        backToMines();
        JOptionPane.showMessageDialog(frame, "GỠ BOM THÀNH CÔNG!");
    }
    ...
    public void onMinigameLose() {
        ...
        int choice = JOptionPane.showOptionDialog(frame, "THẤT BẠI! Bom đã nổ.", "Game Over",
